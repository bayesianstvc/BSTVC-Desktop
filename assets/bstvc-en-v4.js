...
(() => {
  ...
  function wireV3CopyAndLayout() {
    ...
    if (footerMission) footerMission.textContent = "Bayesian Spatiotemporally Varying Coefficients";
    const quietClaim = document.querySelector(".footer-quiet-claim");
    if (quietClaim) quietClaim.textContent = "Advancing Spatiotemporal Interpretability.";
