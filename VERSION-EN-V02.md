# BSTVC English Homepage V02 — Mobile Motion and Compact Modules

- Date: 2026-08-16
- Source: `20260814-BSTVC英文主页首次载入与地图修复-V01-离线包`
- Scope: mobile only; desktop layout and content are retained.
- Changes:
  1. After static first paint, mobile devices load both BSTVC Logo motion iframes; reduced-motion, Save-Data, and low-performance devices retain the static fallback.
